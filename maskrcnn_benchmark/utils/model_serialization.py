...
def align_and_update_state_dicts(model_state_dict, loaded_state_dict, load_mapping):
    ...
    """
    # del loaded_state_dict['roi_heads.relation.predictor.out_oobj.2.weight']
    # del loaded_state_dict['roi_heads.relation.predictor.out_oobj.2.bias']
    # del loaded_state_dict['roi_heads.relation.predictor.out_rel.2.weight']
    # del loaded_state_dict['roi_heads.relation.predictor.out_rel.2.bias']
